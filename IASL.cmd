...
title afandiazmi IDM Activation Script (Activator + Registry Cleaner) v%iasver%
...
set "API_URL=https://api.github.com/repos/afandiazmi/idm/releases/latest"
...
:quit
echo.
echo %GREEN% Thank you for using afandiazmi IDM Activation Script. Have a great day... %RESET%
timeout /t 2 >nul
exit